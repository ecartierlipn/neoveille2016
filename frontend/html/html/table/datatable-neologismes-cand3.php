...
<script type="text/javascript" charset="utf-8" src="js/table.neologismes3.js"></script>
<style>
...
<div class="side-body">
	...
	<div class="tab-content">
			<!-- main pane for gestionnaire néologismes candidats -->
			<div role="tabpanel" class="tab-pane fade in active" id="home">
    	<div class="page-title">
        	<span class="title">Gestionnaire des néologismes candidats</span>
		</div>
        <div class="description">
				<button lang='fr' type="button" onclick="save_to_dict(this.lang);" id="validate" class="btn btn-primary" title="En cliquant, les données validées seront envoyées dans le dictionnaire d'exclusion, ou dans le dictionnaire de référence, soit mots simples, soit mots à traits d'union. Elles ne seront ensuite plus visible dans les candidats néologismes">Valider les faux néologismes</button>
				<button lang='fr' type="button" class="btn btn-primary" onclick="save_to_neo(this.lang);" id="validate2" title="En cliquant, les néologismes validées seront envoyés dans la base des néologismes">Sauvegarder les néologismes validés</button>			
          <!-- choix langue -->
      ...
      <div class="panel-body">
                ...
                <div class="row">
                            <div class="col-sm-12">
                               ...
                               <div class="title">
                                 <a href="#" class="btn btn-info" id="corpusinfoBtn2">Charger les données</a>
                               </div>
                			</div>
                </div>
                <!-- results -->
  ...
  <div class="panel panel-default">
    ...
    <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="<HeadingNine">
      <div class="panel-body">
			...
			<p>Ci-dessous, vous trouverez des informations sur le gestionnaire de corpus et quelques astuces pour constituer un corpus dans une nouvelle langue.</p>
      <h4 class="panel-title">
