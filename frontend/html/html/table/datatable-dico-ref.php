...
<script type="text/javascript" charset="utf-8" src="js/table.dico-ref.js"></script>

	<div class="side-body">
    	<div class="page-title">
        	<span class="title">Gestionnaire des dictionnaires de référence : mots simples</span>
		</div>
		<div class="alert alert-warning alert-dismissible" role="alert">
           <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
           <strong> Attention! </strong>Cette interface permet de visualiser seulement la partie du dictionnaires de référence qui a été alimentée à partir du repérage automatique des néologismes candidats. Elle comprend les formes simples. Vous pouvez éditer ces données si vous considérez intéressant d'ajouter de nouvelles lexies, d'en supprimer ou d'en éditer certaines.            
        </div>

        <div class="description">
          <!-- choix langue -->
           <h5>Choisissez une langue : 
			<select name="langD" id="langD" class="langD">
