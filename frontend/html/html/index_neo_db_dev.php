...
<!--    		<li role="presentation"><a href="#helpc" aria-controls="helpc" role="tab" data-toggle="tab">Aide</a></li> -->
		...
		<div class="tab-content">
        	...
        	<p><img src="./images/details_open.png" width="30px" height="30px"/> : permet d'accéder aux contextes dans la base de corpus dynamique. Possibilité de retourner au texte source en cliquant sur le lien vers la page source.
        	</p><p><img src="./images/statistiques-neo.png" width="30px" height="30px"/> : permet d'obtenir, en plus des contextes, la distribution temporelle, par domaine, par journal. Les graphes sont cliquables et interactifs.
        	</p><p><img src="./images/statistiques-neo-nlp.png" width="30px" height="30px"/> : permet d'obtenir une vision plus approfondie des distributions : distribution temporelle globale, par lemme/partie du discours correspondant à la lexie, par domaine, par journal. Ensuite, sont présentés les contextes analysés automatiquement par Treetagger (5 mots à gauche, 5 mots à droite). on peut filtrer par forme, par lemme et par partie du discours pour découvrir les emplois les plus typiques de la lexie. Les graphes sont cliquables et interactifs. Il est possible de les masquer en cliquant sur le titre de l'en-tête. Cette interface est en cours de développement. 
        	</p><p><img src="./images/google2.png" width="25px" height="25px"/> : permet d'obtenir le graphe de fréquence dans Google Ngrams, pour la lexie.        	
        	</p>Bonne découverte! </p>
		<p><b>Pour l'édition</b> : vous pouvez soit cliquer sur le bouton "édition" (<img src="images/pencil_small.png" width="25px"/>) pour  éditer la fiche complète, soit éditer en ligne dans le tableau qui s'affiche ci-dessous, en cliquant directement, pour une ligne donnée, au niveau de la colonne que vous souhaitez modifier. Pour valider, il suffit de cliquer à un autre endroit. 
Vous pouvez également supprimer une entrée (<img src="images/drop.png" width="25px"/>), mais vous êtes invités à y réfléchir à deux fois!</p><p>Bon travail!</p>
...
<script type="text/javascript" charset="utf-8" src="js/table.neo-db-dev_srv.js"></script>
