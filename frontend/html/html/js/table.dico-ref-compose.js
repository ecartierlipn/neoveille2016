...
$('body').on('change',"#langD2",function(){
                val = this.value;
                //alert(val);
                $('#example').DataTable().ajax.url("php/dico-ref-compose.php?lang="+val).load();
                editor.ajax = "php/dico-ref-compose.php?lang="+val;
                editor.s.ajax = "php/dico-ref-compose.php?lang="+val;
                editor.lang = val;
            });
...
$(document).ready(function() {
	editor = new $.fn.dataTable.Editor( {
		ajax: "php/dico-ref-compose.php?lang=fr",
		table: "#example",
		display: "envelope",
		fields: [ {
				label: "Lexie:",
