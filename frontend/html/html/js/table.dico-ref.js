...
$('body').on('change',"#langD",function(){
                val = this.value;
                //alert(val);
                $('#example').DataTable().ajax.url("php/dico-ref.php?lang="+val).load();
                editor.ajax = "php/dico-ref.php?lang="+val;
                editor.s.ajax = "php/dico-ref.php?lang="+val;
                editor.lang = val;
            });
