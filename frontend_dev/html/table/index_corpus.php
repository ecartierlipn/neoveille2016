...
<!-- dev version with crossfilter and dc.js libraries to visualize data -->
		...
		<!--<script type="text/javascript" charset="utf-8" src="../lib/Editor/js/editor.select2.js"></script>-->
...
<!-- and the main javascript -->
		...
		if ($_SESSION["user_rights"]=="1" or $_SESSION["user_rights"]=="2"){
		  echo '<script type="text/javascript" charset="utf-8" src="js/table.corpus.js"></script>';
		}
		else{
		  echo '<script type="text/javascript" charset="utf-8" src="js/table.corpus_noteditable.js"></script>';
		}
		?>
...
?>
	            ...
	            <div class="row">
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-body">
                                    <table class="datatable table" cellspacing="0" id="RSS_INFO"  class="display" style="width:100% !important;font-size: 0.90em;">
				<thead>
					<tr>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
		                                            ...
		                                            <div id="dc-time-chart<?php echo $lang_iso; ?>" style="width:100% !important;">
		                                            ...
		                                            <div id="range-chart<?php echo $lang_iso; ?>"  style="width:100% !important;"></div>		                                            
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Domaine pie chart -->
