...
<!-- dev version with crossfilter and dc.js libraries to visualize data -->
		...
		<!--<script type="text/javascript" charset="utf-8" src="../js/dc.js-3.0.2/dc.min.js"></script>-->
...
<script type="text/javascript" charset="utf-8" src="js/table.neo-db-dev-demo.js"></script>
	...
	<!--<div class="side-body"> -->
		...
		<div class="tab-content">
        	...
        	<span class="title">Gestionnaire des néologismes : analyse et suivi (français, travail en cours)</span>
		</div>

		<div class="alert alert-info alert-dismissible" role="alert">
        	<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        	Cette interface vous permet de consulter les néologismes validés, en cours de description. vous pouvez trier les colonnes, utiliser les filtres, et obtenir des informations complémentaires
        	en cliquant sur les boutons à droite de chaque ligne.les filtres peuvent utiliser des expressions régulières.</p>
          ...
          <!-- language select box -->
           <h5>Choisissez une langue : 
			<select name="currentLanguage" id="currentLanguage" class="currentLanguage"  style="width:150px;">
			<?php 
        ...
        <div class="description">
            <div class="row">
            	<div class="col-xs-12">
                	<div class="card">
                    	<div class="card-body">
                            <table class="datatable table" cellspacing="0" id="exampleNeo" style="width:100vw !important;">
								<thead>
									<tr>
										<th>Lexie</th>
										<th>Type</th>
    ...
    <!--        <div class="modal fade row row-example" id="neoResultsfr" style="display:none;" tabindex="-1" role="dialog" aria-hidden="true"> -->
