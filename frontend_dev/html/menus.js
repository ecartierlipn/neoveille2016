...
$('#sources').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#encoding').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );					
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-encoding.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#format').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-format.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#newspaper').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );					
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-newspaper.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#domain').click(function()
{
				...
				//alert($("#container-fluid").html());
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-domain.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#country').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-country.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#lang').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_corpus-lang.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#dico-ref').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_dico-ref.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#dico-ref2').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_dico-ref-compose.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#dico-ref3').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_dico-ref-termino.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
...
$('#dico-excl').click(function()
{
					...
					$( "li.active" ).attr( "class", "inactive" );
					$( this ).closest( "li" ).attr( "class", "active" );
        	    	$("#container-fluid").load("table/index_dico-ref-excluded.php",function(responseTxt, statusTxt, xhr)
        	    	{
        			//if(statusTxt == "success")
            			//alert("External content loaded successfully!");
        			if(statusTxt == "error")
