...
$('body').on('change',"#langD",function(){
                val = this.value;
                //alert(val);
                $('#example').DataTable().ajax.url("php/table.dico-ref-termino.php?lang="+val).load();
                editor.ajax = "php/table.dico-ref-termino.php?lang="+val;
                editor.s.ajax = "php/table.dico-ref-termino.php?lang="+val;
                editor.lang = val;
            });
...
$(document).ready(function() {
	editor = new $.fn.dataTable.Editor( {
		ajax: "php/table.dico-ref-termino.php?lang=fr",
		table: "#example",
		display: "envelope",
		fields: [ {
				label: "Lexie:",
