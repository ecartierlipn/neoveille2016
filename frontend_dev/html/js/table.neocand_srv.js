...
editor = new $.fn.dataTable.Editor( {
		...
		ajax: {url:"./php/table.neocand.php?lang="+languageW,type:"POST"},
		table: "#example",
		lang:languageW,
		display: "envelope",
		fields: [ {
...
$('body').on('change',"#lang",function(){
                val = this.value;
                console.log(val);
                editor.ajax = "php/table.neocand.php?lang="+val;
                editor.s.ajax = "php/table.neocand.php?lang="+val;
                editor.lang = val;
		table.state.clear();
                table.ajax.url("php/table.neocand.php?lang="+val).load();
...
// Setup filter - add a text input to each header cell (filter row)
...
//			"selectAll","selectNone",
			...
			{ extend: 'colvis',
				...
				columnText: function ( table, idx, title ) {
