...
console.log("Working Language : ");
console.log(lang);
console.log("Solr Host : " );
...
editor = new $.fn.dataTable.Editor( {
		//ajax: "php/neologismes.demo.php?lang="+lang,
		ajax: {url:"./php/neologismes.demo.php?lang="+lang},
		table: "#example",
		lang:lang,	
	} );
...
$('body').on('change',"#chooselang",function(){
                val = this.value;
                console.log("New value for language : " + val);
                editor.ajax = "php/neologismes.demo.php?lang="+val;
                editor.s.ajax = "php/neologismes.demo.php?lang="+val;
                editor.lang = val;
		table.state.clear();
                table.ajax.url("php/neologismes.demo.php?lang="+val).load();
...
table = $('#example').DataTable( {
		...
		serverSide:true,
		search: {regex: true},
		ajax: {url:"./php/neologismes.demo.php?lang="+lang,type:"POST"},
