...
lang_solr={'nl':'netherlands','de':'german','pl':'polish','cz':'czech','ru':'russian','ch':'chinese','gr':'greek','br':'brasilian','fr':'french'}
# 13/12/2016 : to integrate french
lang_solr2={'de':'rss_german','nl':'rss_netherlands','pl':'RSS_polish','cz':'RSS_czech','ru':'RSS_russian','ch':'RSS_chinese','gr':'RSS_greek','br':'RSS_brasilian','fr':'rss_french'}
...
#    for lang in ('Rép. Tchèque','pologne','grèce','russie','brésil','chine'):# to be replaced by a select language in database
    for lang in ['Rép. Tchèque','pologne','grèce','russie','brésil','chine','allemagne','pays-bas','france']:# to be replaced by a select in database
...
if __name__ == '__main__':
    ...
    logging.basicConfig(format=FORMAT, datefmt='%m/%d/%Y %I:%M:%S %p', filename="./log/corpus_all.log", filemode='w', level=logging.INFO)    
