...
#    for lang in ('Rép. Tchèque','pologne','grèce','russie','brésil','chine'):# to be replaced by a select language in database
    for lang in ['allemagne','pays-bas']:# to be replaced by a select in database
...
if __name__ == '__main__':
    ...
    logging.basicConfig(format=FORMAT, datefmt='%m/%d/%Y %I:%M:%S %p', filename="./log/corpus_de.log", filemode='w', level=logging.INFO)    
