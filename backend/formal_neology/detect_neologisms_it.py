...
## global config
lang_solr={'italie':'rss_italian','france':'rss_french','pologne':'RSS_polish','Rép. Tchèque':'RSS_czech','russie':'RSS_russian','chine':'RSS_chinese','gr':'RSS_greek','brésil':'RSS_brasilian'}
...
class document:
    ...
    def pos_tagging(self):
        ...
        if self.lang in ('brésil','chine','pologne','russie','france','italie'):
...
if __name__ == '__main__':
    ...
    logging.basicConfig(format=FORMAT, datefmt='%m/%d/%Y %I:%M:%S %p', filename="./log/detect_neologisms_it.py.log", filemode='w', level=logging.INFO)    
