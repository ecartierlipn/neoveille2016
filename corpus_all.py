...
# -*- coding: utf-8 -*-
'''
corpus class for retrieving list of rss feeds or web sites or twitter
...
lang_solr={'pl':'polish','cz':'czech','ru':'russian','ch':'chinese','gr':'greek','br':'brasilian','fr':'french'}
# 13/12/2016 : to integrate french
lang_solr2={'pl':'RSS_polish','cz':'RSS_czech','ru':'RSS_russian','ch':'RSS_chinese','gr':'RSS_greek','br':'RSS_brasilian','fr':'rss_french'}
...
#    for lang in ('Rép. Tchèque','pologne','grèce','russie','brésil','chine'):# to be replaced by a select language in database
    for lang in ['Rép. Tchèque','pologne','grèce','russie','brésil','chine']:# to be replaced by a select in database
